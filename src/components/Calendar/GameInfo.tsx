...
const GameInfo = ({competation,hometeam,uriLogo,jorney,awayteam,uriAwayLogo,timestamp,resultHome,resultaway,isStart}:IGame) => {
  function formatDate() {
...
return  <Animated.View sharedTransitionTag="sharedTag" className='w-full h-44'>
          ...
          <View className=' justify-center mb-[-8]  items-center'>
              ...
              <View className='w-20 flex-row mt-2  justify-between'>
                  <View className='bg-white w-9 mr-2 h-10 rounded-md justify-center items-center'>
                    <Text className={`font-dinCondensed  text-lg  text-bgauth ${Platform.OS === 'ios' && 'leading-9  pt-2'}`}>
